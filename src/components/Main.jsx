...
const Main = () => {
  ...
  return (
    <div className="md:p-[4rem] max-md:p-[1rem]">
      {/* Top Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-3 justify-between items-start w-[20rem] lg:w-[30rem]">
        ...
        <div className="max-md:hidden md:pl-[1rem] flex flex-col justify-end lg:justify-center">
      ...
      <div className="relative mt-[4rem] flex max-md:flex-col justify-center items-center gap-4">
        ...
        {/* Floating Button */}
        <div className="flex justify-center mt-4 md:mt-0 absolute top- md:-top-6 md:left-1/2 md:-translate-x-1/2">
      ...
      <div className="my-[2rem] mt-[4rem] grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="max-md:hidden md:pl-[1rem] md:pt-[2rem] flex flex-col justify-end">
          <p className="text-sm text-gray-600 w-[90%]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto
            accusamus sapiente aspernatur id, dolore inventore?
          </p>
      ...
      {/* Categories Section */}
      <div className="my-[2rem] flex justify-evenly items-center gap-4 overflow-x-auto p-2 scrollbar-hide border border-gray-300 rounded-full">
